...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'Olympus_Range_Slider_Control' ) ) {
	/**
	 * Create a range slider control.
	 * This control allows you to add responsive settings.
	 */
	class Olympus_Range_Slider_Control extends WP_Customize_Control {
		/**
		 * The control type.
		 *
		 * @access public
		 * @var string
		 */
		public $type = 'olympus-range-slider';
		...
		public function to_json() {
			...
			$this->json['desktop_label'] = __( 'Desktop', 'olympuswp' );
			$this->json['tablet_label'] = __( 'Tablet', 'olympuswp' );
			$this->json['mobile_label'] = __( 'Mobile', 'olympuswp' );
			$this->json['reset_label'] = __( 'Reset', 'olympuswp' );
		...
		public function enqueue() {
			wp_enqueue_script(
				'olympus-range-slider',
				trailingslashit( get_template_directory_uri() ) . 'inc/controls/js/slider-control.js',
				array(
					'jquery',
					'customize-base',
					'jquery-ui-slider',
			...
			wp_enqueue_style(
				'olympus-range-slider-css',
				trailingslashit( get_template_directory_uri() ) . 'inc/controls/css/slider-customizer.css',
				array(),
				OLY_VERSION
			);
		}
		...
		protected function content_template() {
			?>
			<div class="olympus-range-slider-control">
				<div class="olympus-range-title-area">
					<# if ( data.label || data.description ) { #>
						<div class="olympus-range-title-info">
							<# if ( data.label ) { #>
					...
					<div class="olympus-range-slider-controls">
						<span class="olympus-device-controls">
							<# if ( 'undefined' !== typeof ( data.desktop ) ) { #>
								<span class="olympus-device-desktop dashicons dashicons-desktop" data-option="desktop" title="{{ data.desktop_label }}"></span>
							<# } #>

							<# if ( 'undefined' !== typeof (data.tablet) ) { #>
								<span class="olympus-device-tablet dashicons dashicons-tablet" data-option="tablet" title="{{ data.tablet_label }}"></span>
							<# } #>

							<# if ( 'undefined' !== typeof (data.mobile) ) { #>
								<span class="olympus-device-mobile dashicons dashicons-smartphone" data-option="mobile" title="{{ data.mobile_label }}"></span>
							<# } #>
						</span>

						<span title="{{ data.reset_label }}" class="olympus-reset dashicons dashicons-image-rotate"></span>
					</div>
				</div>

				<div class="olympus-range-slider-areas">
					<# if ( 'undefined' !== typeof ( data.desktop ) ) { #>
						<label class="range-option-area" data-option="desktop" style="display: none;">
							<div class="wrapper <# if ( '' !== data.choices['desktop']['unit'] ) { #>has-unit<# } #>">
								<div class="olympus-slider" data-step="{{ data.choices['desktop']['step'] }}" data-min="{{ data.choices['desktop']['min'] }}" data-max="{{ data.choices['desktop']['max'] }}"></div>

								<div class="olympus_range_value <# if ( '' == data.choices['desktop']['unit'] && ! data.choices['desktop']['edit'] ) { #>hide-value<# } #>">
					...
					<# if ( 'undefined' !== typeof ( data.tablet ) ) { #>
						<label class="range-option-area" data-option="tablet" style="display:none">
							<div class="wrapper <# if ( '' !== data.choices['tablet']['unit'] ) { #>has-unit<# } #>">
								<div class="olympus-slider" data-step="{{ data.choices['tablet']['step'] }}" data-min="{{ data.choices['tablet']['min'] }}" data-max="{{ data.choices['tablet']['max'] }}"></div>

								<div class="olympus_range_value <# if ( '' == data.choices['tablet']['unit'] && ! data.choices['desktop']['edit'] ) { #>hide-value<# } #>">
					...
					<# if ( 'undefined' !== typeof ( data.mobile ) ) { #>
						<label class="range-option-area" data-option="mobile" style="display:none;">
							<div class="wrapper <# if ( '' !== data.choices['mobile']['unit'] ) { #>has-unit<# } #>">
								<div class="olympus-slider" data-step="{{ data.choices['mobile']['step'] }}" data-min="{{ data.choices['mobile']['min'] }}" data-max="{{ data.choices['mobile']['max'] }}"></div>

								<div class="olympus_range_value <# if ( '' == data.choices['mobile']['unit'] && ! data.choices['desktop']['edit'] ) { #>hide-value<# } #>">
