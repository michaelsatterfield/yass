...
if ( ! function_exists( 'olympus_enqueue_google_fonts' ) ) {
	add_action( 'wp_enqueue_scripts', 'olympus_enqueue_google_fonts', 0 );
	/**
	 * Add Google Fonts to wp_head if needed.
	 */
	function olympus_enqueue_google_fonts() {
		$olympus_settings = wp_parse_args(
			get_option( 'olympus_settings', array() ),
			olympus_get_default_fonts()
		);

		$not_google = str_replace( ' ', '+', olympus_typography_default_fonts() );
		...
		if ( ! empty( $font_settings ) ) {
			...
			foreach ( $font_settings as $key ) {
				...
				if ( ! isset( $olympus_settings[ $key ] ) ) {
					continue;
				}

				// If our value is still using the old format, fix it.
				if ( strpos( $olympus_settings[ $key ], ':' ) !== false ) {
					$olympus_settings[ $key ] = current( explode( ':', $olympus_settings[ $key ] ) );
				}

				$value = str_replace( ' ', '+', $olympus_settings[ $key ] );

				$variants = olympus_get_google_font_variants( $olympus_settings[ $key ], $key );
		...
		$google_fonts = apply_filters( 'olympus_typography_google_fonts', $google_fonts );

		$subset = apply_filters( 'olympus_fonts_subset', '' );
		...
		$display = apply_filters( 'olympus_google_font_display', '' );
		...
		if ( $google_fonts ) {
			wp_enqueue_style( 'olympus-fonts', $fonts_url, array(), null, 'all' ); // phpcs:ignore
		}
	}
}
...
if ( ! function_exists( 'olympus_default_fonts_customize_register' ) ) {
	...
	function olympus_default_fonts_customize_register( $wp_customize ) {
		...
		require_once trailingslashit( dirname( __FILE__ ) ) . 'controls/class-olympus-typography-control.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

		$defaults = olympus_get_default_fonts();

		if ( method_exists( $wp_customize, 'register_control_type' ) ) {
			$wp_customize->register_control_type( 'Olympus_Typography_Control' );
		...
		$wp_customize->add_setting(
			...
			array(
				...
				'sanitize_callback' => 'olympus_sanitize_variants',
			)
		);
		...
		$wp_customize->add_control(
			new Olympus_Typography_Control(
				$wp_customize,
				'body_typography',
				array(
					'label' => __( 'Body', 'olympuswp' ),
					'section' => 'font_section',
					'priority' => 1,
					'settings' => array(
						'family' => 'olympus_settings[font_body]',
						'variant' => 'font_body_variants',
						'category' => 'font_body_category',
						'weight' => 'olympus_settings[body_font_weight]',
						'transform' => 'olympus_settings[body_font_transform]',
					),
				)
			)
		);
		...
		$wp_customize->add_setting(
			'olympus_settings[mobile_body_font_size]',
			array(
		...
		$wp_customize->add_control(
			new Olympus_Range_Slider_Control(
				...
				'body_font_size',
				array(
					'description' => __( 'Font size', 'olympuswp' ),
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'olympus_settings[body_font_size]',
						'mobile' => 'olympus_settings[mobile_body_font_size]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 6,
		...
		$wp_customize->add_control(
			new Olympus_Range_Slider_Control(
				...
				array(
					...
					'description' => __( 'Line height', 'olympuswp' ),
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'olympus_settings[body_line_height]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 1,
		...
		$wp_customize->add_control(
			new Olympus_Typography_Control(
				...
				array(
					'label' => __( 'Heading 1 (H1)', 'olympuswp' ),
					'section' => 'font_section',
					'settings' => array(
						'family' => 'olympus_settings[font_heading_1]',
						'variant' => 'font_heading_1_variants',
						'category' => 'font_heading_1_category',
						'weight' => 'olympus_settings[heading_1_weight]',
						'transform' => 'olympus_settings[heading_1_transform]',
					),
				)
			)
		);
		...
		$wp_customize->add_setting(
			'olympus_settings[mobile_heading_1_font_size]',
			array(
		...
		$wp_customize->add_control(
			new Olympus_Range_Slider_Control(
				$wp_customize,
				'heading_1_font_sizes',
				array(
					'description' => __( 'Font size', 'olympuswp' ),
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'olympus_settings[heading_1_font_size]',
						'mobile' => 'olympus_settings[mobile_heading_1_font_size]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 15,
		...
		$wp_customize->add_control(
			new Olympus_Range_Slider_Control(
				...
				array(
					...
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'olympus_settings[heading_1_line_height]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 0,
		...
		$wp_customize->add_control(
			new Olympus_Typography_Control(
				...
				array(
					'label' => __( 'Heading 2 (H2)', 'olympuswp' ),
					'section' => 'font_section',
					'settings' => array(
						'family' => 'olympus_settings[font_heading_2]',
						'variant' => 'font_heading_2_variants',
						'category' => 'font_heading_2_category',
						'weight' => 'olympus_settings[heading_2_weight]',
						'transform' => 'olympus_settings[heading_2_transform]',
					),
				)
			)
		);
		...
		$wp_customize->add_setting(
			'olympus_settings[mobile_heading_2_font_size]',
			array(
		...
		$wp_customize->add_control(
			new Olympus_Range_Slider_Control(
				$wp_customize,
				'heading_2_font_sizes',
				array(
					'description' => __( 'Font size', 'olympuswp' ),
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'olympus_settings[heading_2_font_size]',
						'mobile' => 'olympus_settings[mobile_heading_2_font_size]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 15,
		...
		$wp_customize->add_control(
			new Olympus_Range_Slider_Control(
				...
				array(
					...
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'olympus_settings[heading_2_line_height]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 0,
		...
		$wp_customize->add_control(
			new Olympus_Typography_Control(
				...
				array(
					'label' => __( 'Heading 3 (H3)', 'olympuswp' ),
					'section' => 'font_section',
					'settings' => array(
						'family' => 'olympus_settings[font_heading_3]',
						'variant' => 'font_heading_3_variants',
						'category' => 'font_heading_3_category',
						'weight' => 'olympus_settings[heading_3_weight]',
						'transform' => 'olympus_settings[heading_3_transform]',
					),
				)
			)
		);
		...
		$wp_customize->add_control(
			new Olympus_Range_Slider_Control(
				$wp_customize,
				'heading_3_font_sizes',
				array(
					'description' => __( 'Font size', 'olympuswp' ),
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'olympus_settings[heading_3_font_size]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 15,
		...
		$wp_customize->add_control(
			new Olympus_Range_Slider_Control(
				...
				array(
					...
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'olympus_settings[heading_3_line_height]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 0,
		...
		$wp_customize->add_control(
			new Olympus_Typography_Control(
				...
				array(
					'label' => __( 'Heading 4 (H4)', 'olympuswp' ),
					'section' => 'font_section',
					'settings' => array(
						'family' => 'olympus_settings[font_heading_4]',
						'variant' => 'font_heading_4_variants',
						'category' => 'font_heading_4_category',
						'weight' => 'olympus_settings[heading_4_weight]',
						'transform' => 'olympus_settings[heading_4_transform]',
					),
				)
			)
		);
		...
		$wp_customize->add_control(
			new Olympus_Range_Slider_Control(
				$wp_customize,
				'heading_4_font_sizes',
				array(
					'description' => __( 'Font size', 'olympuswp' ),
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'olympus_settings[heading_4_font_size]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 15,
		...
		$wp_customize->add_control(
			new Olympus_Range_Slider_Control(
				...
				array(
					...
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'olympus_settings[heading_4_line_height]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 0,
		...
		$wp_customize->add_control(
			new Olympus_Typography_Control(
				...
				array(
					'label' => __( 'Heading 5 (H5)', 'olympuswp' ),
					'section' => 'font_section',
					'settings' => array(
						'family' => 'olympus_settings[font_heading_5]',
						'variant' => 'font_heading_5_variants',
						'category' => 'font_heading_5_category',
						'weight' => 'olympus_settings[heading_5_weight]',
						'transform' => 'olympus_settings[heading_5_transform]',
					),
				)
			)
		);
		...
		$wp_customize->add_control(
			new Olympus_Range_Slider_Control(
				$wp_customize,
				'heading_5_font_sizes',
				array(
					'description' => __( 'Font size', 'olympuswp' ),
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'olympus_settings[heading_5_font_size]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 15,
		...
		$wp_customize->add_control(
			new Olympus_Range_Slider_Control(
				...
				array(
					...
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'olympus_settings[heading_5_line_height]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 0,
		...
		$wp_customize->add_control(
			new Olympus_Typography_Control(
				...
				array(
					'label' => __( 'Heading 6 (H6)', 'olympuswp' ),
					'section' => 'font_section',
					'settings' => array(
						'family' => 'olympus_settings[font_heading_6]',
						'variant' => 'font_heading_6_variants',
						'category' => 'font_heading_6_category',
						'weight' => 'olympus_settings[heading_6_weight]',
						'transform' => 'olympus_settings[heading_6_transform]',
					),
				)
			)
		);
		...
		$wp_customize->add_control(
			new Olympus_Range_Slider_Control(
				$wp_customize,
				'heading_6_font_sizes',
				array(
					'description' => __( 'Font size', 'olympuswp' ),
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'olympus_settings[heading_6_font_size]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 15,
		...
		$wp_customize->add_control(
			new Olympus_Range_Slider_Control(
				...
				array(
					...
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'olympus_settings[heading_6_line_height]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 0,
...
if ( ! function_exists( 'olympus_get_all_google_fonts' ) ) {
	/**
	 ...
	 */
	function olympus_get_all_google_fonts( $amount = 'all' ) {
		...
		if ( apply_filters( 'olympus_alphabetize_google_fonts', true ) ) {
			asort( $fonts );
		}

		return apply_filters( 'olympus_google_fonts_array', $fonts );
	}
}

if ( ! function_exists( 'olympus_get_all_google_fonts_ajax' ) ) {
	add_action( 'wp_ajax_olympus_get_all_google_fonts_ajax', 'olympus_get_all_google_fonts_ajax' );
	/**
	 * Return an array of all of our Google Fonts.
	 */
	function olympus_get_all_google_fonts_ajax() {
		if ( ! isset( $_POST['olympus_customize_nonce'] ) || ! wp_verify_nonce( sanitize_key( $_POST['olympus_customize_nonce'] ), 'olympus_customize_nonce' ) ) {
			wp_die();
		}

		check_ajax_referer( 'olympus_customize_nonce', 'olympus_customize_nonce' );

		if ( ! current_user_can( 'edit_theme_options' ) ) {
			wp_die();
		}

		$fonts = olympus_get_all_google_fonts();
...
if ( ! function_exists( 'olympus_get_google_font_variants' ) ) {
	/**
	 * Wrapper function to find variants for chosen Google Fonts
	 * Example: olympus_get_google_font_variation( 'Open Sans' )
	 *
	 * @param string $font The font to look up.
	 * @param string $key The option to look up.
	 */
	function olympus_get_google_font_variants( $font, $key = '' ) {
		// Don't need variants if we're using a system font.
		if ( in_array( $font, olympus_typography_default_fonts() ) ) {
			return;
		}
		...
		if ( $variants ) {
			...
			return implode( ',', apply_filters( 'olympus_typography_variants', $output ) );
		}
	}
}

if ( ! function_exists( 'olympus_get_google_font_category' ) ) {
	/**
	 * Wrapper function to find the category for chosen Google Font
	 * Example: olympus_get_google_font_category( 'Open Sans' )
	 *
	 * @param string $font The name of our font.
	 * @param string $key The ID of the font setting.
	 * @return string The category of our font.
	 */
	function olympus_get_google_font_category( $font, $key = '' ) {
...
if ( ! function_exists( 'olympus_get_font_family_css' ) ) {
	/**
	 ...
	 */
	function olympus_get_font_family_css( $font, $settings, $default ) {
		$olympus_settings = wp_parse_args(
		...
		$no_quotes = array(
			...
			apply_filters( 'olympus_typography_system_stack', '-apple-system, system-ui, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"' ),
		);

		$font_family = $olympus_settings[ $font ];

		if ( 'System Stack' === $font_family ) {
			$font_family = apply_filters( 'olympus_typography_system_stack', '-apple-system, system-ui, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"' );
		}
		...
		if ( in_array( $font_family, $no_quotes ) ) {
			...
			$wrapper_start = '"';
			$wrapper_end = '"' . olympus_get_google_font_category( $font_family, $font );
		}
...
if ( ! function_exists( 'olympus_add_to_font_customizer_list' ) ) {
	add_filter( 'olympus_typography_customize_list', 'olympus_add_to_font_customizer_list' );
	/**
	 ...
	 */
	function olympus_add_to_font_customizer_list( $fonts ) {
		...
		$all_fonts = olympus_get_all_google_fonts();
		$select_fonts = olympus_get_all_google_fonts( apply_filters( 'olympus_number_of_fonts', 200 ) );

		foreach ( $font_settings as $setting ) {
			// If we don't have a setting, keep going.
			if ( ! isset( $olympus_settings[ $setting ] ) ) {
				continue;
			}

			$id = strtolower( str_replace( ' ', '_', $olympus_settings[ $setting ] ) );

			if ( array_key_exists( $id, $select_fonts ) || in_array( $olympus_settings[ $setting ], olympus_typography_default_fonts() ) ) {
				continue;
			}

			$fonts[ strtolower( str_replace( ' ', '_', $olympus_settings[ $setting ] ) ) ] = array(
				'name' => $olympus_settings[ $setting ],
		...
		if ( function_exists( 'olympus_secondary_nav_get_defaults' ) ) {
			$secondary_nav_settings = wp_parse_args(
				get_option( 'olympus_secondary_nav_settings', array() ),
				olympus_secondary_nav_get_defaults()
			);

			$secondary_nav_id = strtolower( str_replace( ' ', '_', $secondary_nav_settings['font_secondary_navigation'] ) );

			if ( ! array_key_exists( $secondary_nav_id, $select_fonts ) && ! in_array( $secondary_nav_settings['font_secondary_navigation'], olympus_typography_default_fonts() ) ) {
...
if ( ! function_exists( 'olympus_typography_set_font_data' ) ) {
	add_action( 'admin_init', 'olympus_typography_set_font_data' );
	/**
	 ...
	 */
	function olympus_typography_set_font_data() {
		// Get our defaults.
		$defaults = olympus_get_default_fonts();
		...
		if ( $defaults['font_body'] == $olympus_settings['font_body'] ) { // phpcs:ignore
			return;
		}

		// Don't need to continue if we're using a system font or our default font.
		if ( in_array( $olympus_settings['font_body'], olympus_typography_default_fonts() ) ) {
			return;
		}
		...
		// Get the ID from our font.
		$id = strtolower( str_replace( ' ', '_', $olympus_settings['font_body'] ) );
